...
export default function SignupScreen() {
  ...
  const handleSignup = () => {
    ...
    console.log("Criando conta com:", name, username, email, password)
  }
  ...
  const handleGameCenterSignup = () => {
    console.log("Cadastro com Game Center")
  }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#000000] p-5 text-white">
      ...
      <div className="flex flex-col mt-4">
        ...
        <p className="text-[#999999] text-sm mb-8">Cadastre-se agora para uma experiência completa nos seus games!</p>
        ...
        <div className="mb-8">
          <button
            onClick={handleGameCenterSignup}
        ...
        <div className="flex justify-center items-center">
          ...
          <button className="text-[#00E676] text-sm font-medium ml-1">Fazer login</button>
        </div>
      </div>
    </div>
  )
